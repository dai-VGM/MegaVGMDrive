...
const char *rbf(Profile p) {
    return p == Profile::A ? "/media/fat/_Utility/MegaVGMPlayer_Transport13FadeOnly_A_MiSTer.rbf" :
        p == Profile::B ? "/media/fat/_Utility/MegaVGMPlayer_Transport13FadeOnly_B_MiSTer.rbf" : "";
}
