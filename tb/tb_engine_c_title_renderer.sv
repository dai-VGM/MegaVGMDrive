...
module tb_engine_c_title_renderer;
    ...
    initial begin
        #1;
        if({dut.info_character(4),dut.info_character(5),dut.info_character(6),dut.info_character(7)}!=={"6","5","8","1"}) $fatal(1,"6581 label");
        if(dut.info_character(10)!="P" || dut.info_character(11)!="A" || dut.info_character(12)!="L") $fatal(1,"PAL label");
        sid_timing_ntsc=1;#1;
        if({dut.info_character(4),dut.info_character(5),dut.info_character(6),dut.info_character(7)}!=={"6","5","8","1"}) $fatal(1,"6581 NTSC label");
        if(dut.info_character(10)!="N" || dut.info_character(11)!="T" || dut.info_character(12)!="S" || dut.info_character(13)!="C") $fatal(1,"NTSC label");
        sid_model_8580=1;sid_timing_ntsc=0;#1;
        if({dut.info_character(4),dut.info_character(5),dut.info_character(6),dut.info_character(7)}!=={"8","5","8","0"}) $fatal(1,"8580 PAL label");
        if(dut.info_character(10)!="P" || dut.info_character(11)!="A" || dut.info_character(12)!="L") $fatal(1,"8580 PAL timing label");
        sid_timing_ntsc=1;#1;
        if({dut.info_character(4),dut.info_character(5),dut.info_character(6),dut.info_character(7)}!=={"8","5","8","0"}) $fatal(1,"8580 NTSC label");
        if(dut.info_character(10)!="N" || dut.info_character(11)!="T" || dut.info_character(12)!="S" || dut.info_character(13)!="C") $fatal(1,"8580 NTSC timing label");
