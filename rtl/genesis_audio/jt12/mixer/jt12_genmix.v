...
integer debug_genmix_x_count = 0;
reg [1:0] psgcnt144;
...
always @(posedge clk) begin
    if (!rst && debug_genmix_x_count < 40 &&
        (((^fm_left) === 1'bx) || ((^fm_right) === 1'bx) ||
         ((^psg_snd) === 1'bx) || ((^snd_left) === 1'bx) ||
         ((^snd_right) === 1'bx))) begin
        debug_genmix_x_count = debug_genmix_x_count + 1;
        $display("GENMIX_X count=%0d time=%0t fm_l=%0d fm_r=%0d psg=%0d fm_en=%0b psg_en=%0b left_mixed=%0d left_fm2=%0d left_fm3=%0d left_fm4=%0d snd_l=%0d right_mixed=%0d right_fm2=%0d right_fm3=%0d right_fm4=%0d snd_r=%0d",
                 debug_genmix_x_count, $time, fm_left, fm_right, psg_snd,
                 fm_en, psg_en,
                 u_left.mixed, u_left.fm2, u_left.fm3, u_left.fm4, snd_left,
                 u_right.mixed, u_right.fm2, u_right.fm3, u_right.fm4, snd_right);
    end
end
`endif
