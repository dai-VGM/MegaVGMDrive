...
`ifdef VERBOSE_TB_LOG
            ...
            if (debug_write_count <= 50) begin
                $display("JT89_WRITE count=%0d time=%0t din=%02h reg_sel=%03b regn_before=%03b tone0_before=%03h tone1_before=%03h tone2_before=%03h vol_before=%x%x%x%x ctrl3_before=%03b",
                         debug_write_count, $time, din, reg_sel, regn,
                         tone0, tone1, tone2, vol0, vol1, vol2, vol3, ctrl3);
                $strobe("JT89_AFTER count=%0d time=%0t regn=%03b tone0=%03h tone1=%03h tone2=%03h vol=%x%x%x%x ctrl3=%03b clr_noise=%0b",
                        debug_write_count, $time, regn, tone0, tone1, tone2,
                        vol0, vol1, vol2, vol3, ctrl3, clr_noise);
            end
`endif
