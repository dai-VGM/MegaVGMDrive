...
`endif
    ...
    golden_player_shell_v1_1_profile #(
        ...
        .clk_sys(clk),
        .reset(reset),
        .download_active(ioctl_download && ioctl_index == VGM_LOAD_FILE_INDEX),
    ...
    golden_player_shell_upload #(
        ...
        .clk(clk),
        .reset(reset),
        .ioctl_download(ioctl_download && ioctl_index == VGM_LOAD_FILE_INDEX),
        .ioctl_wr(ioctl_wr),
    ...
    assign player_done = profile_done;
