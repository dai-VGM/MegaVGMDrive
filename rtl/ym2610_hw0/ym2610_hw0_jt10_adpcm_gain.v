...
// HW-0-only Icarus/Quartus-common spelling of the pristine gain block.
// Declaration order is the existing compatibility generator's only change.
module ym2610_hw0_jt10_adpcm_gain(
    input           rst_n,
    input           clk,        // CPU clock
    input           cen,        // 666 kHz
    // pipeline channel
...
endmodule // ym2610_hw0_jt10_adpcm_gain
